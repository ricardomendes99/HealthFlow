...
import {
  ...
  ChevronRight, Copy, ExternalLink, LogOut, ChevronDown, AlertTriangle
} from 'lucide-react'
        ...
        {!supabase && !collapsed && (
          <div className="mx-3 mt-3 bg-amber-50 border border-amber-200 rounded-xl px-3 py-2 flex items-start gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-amber-600 leading-tight mt-0.5">Dados locais — não persistem após recarregar. Configure o Supabase para salvar de verdade.</p>
            </div>
          </div>
        )}
        {!supabase && collapsed && (
          <div className="flex justify-center mt-3" title="Modo Demo — dados não persistem">
