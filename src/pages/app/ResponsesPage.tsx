...
export default function ResponsesPage() {
  const [selected, setSelected] = useState(mockCheckIns[0])
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <div className="text-xs text-slate-400 mt-0.5">{ci.data_resposta}</div>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-black text-primary-600">{ci.pontuacao_percentual}%</div>
                    {ci.comparativo !== undefined && (
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-slate-500">{selected.questionario_nome} · {selected.data_resposta}</p>
              </div>
              <div className="text-right">
                <div className="text-4xl font-black text-primary-600">{selected.pontuacao_percentual}%</div>
                {selected.comparativo !== undefined && (
